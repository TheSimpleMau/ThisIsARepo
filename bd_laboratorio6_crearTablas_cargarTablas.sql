...
-- Querys de prueba - A01711522 - Mauricio Olguín Sánchez

-- Obtener la descripción, razon social y fecha de todos los materiales entregados para el proyecto llamado 'Vamos Mexico'
SELECT M.descripcion, Prove.razonsocial, E.fecha 
FROM materiales M, entregan E, proveedores Prove, proyectos Proye 
WHERE M.clave = E.clave 
AND Proye.denominacion = 'Vamos Mexico';

-- Contar todas las entregas para cada uno de los materiales en todos los proyectos
SELECT Proyec.denominacion, M.descripcion , E.cantidad as 'Cantidad entregada de material'
FROM proyectos Proyec, entregan E, materiales M
