...
let tablaExponentes = '<table class="table table-striped-column">';
tablaExponentes += '<thead> <tr><th scope="col">Número</th><th scope="col">Cuadrado</th><th scope="col">Cubo</th></tr> </thead>'; // Para los encabezados de la tabla
tablaExponentes += "<tbody>";
